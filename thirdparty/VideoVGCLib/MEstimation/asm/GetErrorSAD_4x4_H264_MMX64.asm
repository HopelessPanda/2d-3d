;
; GetErrorSAD_4x4_H264_MMX64_asm(const BYTE* pSrc1, const BYTE* pSrc2, const BYTE* blockRef, const int strideRef, int iStride, int h264_blend);
; params:
...
.code 
PUBLIC GetErrorSAD_4x4_H264_MMX64_asm 
GetErrorSAD_4x4_H264_MMX64_asm PROC
	;push	rbp
	;mov	rbp, rsp
	;sub	rsp, 16
	...
	movd mm5, dword ptr [rsi + 2 * rdx]

	por mm1, mm4
	por mm3, mm5

	movd mm0, dword ptr [rbx]
	movd mm2, dword ptr [rbx + 2 * rdx]
	add rbx, rdx
	...
	movd mm2, dword ptr [rdi + 2 * rax]
	add rdi, rax

	psllq mm0, 32
	psllq mm2, 32

	movd mm4, dword ptr [rdi]
	movd mm5, dword ptr [rdi + 2 * rax]
...
GetErrorSAD_4x4_H264_MMX64_asm ENDP
End
