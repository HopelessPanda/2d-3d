;
; GetErrorSAD_16x8_H264_MMX64_asm(const BYTE* pSrc1, const BYTE* pSrc2, const BYTE* blockRef, const int strideRef, int iStride, int h264_blend);
; params:
...
.code 
PUBLIC GetErrorSAD_16x8_H264_MMX64_asm
GetErrorSAD_16x8_H264_MMX64_asm PROC
	;push	rbp
	;mov	rbp, rsp
	;sub	rsp, 16
...
GetErrorSAD_16x8_H264_MMX64_asm ENDP
End
