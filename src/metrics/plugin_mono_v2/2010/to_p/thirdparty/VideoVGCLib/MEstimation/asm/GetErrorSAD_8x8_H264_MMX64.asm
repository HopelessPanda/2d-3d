;
; GetErrorSAD_8x8_H264_MMX64_asm(const BYTE* pSrc1, const BYTE* pSrc2, const BYTE* blockRef, const int strideRef, int iStride, int h264_blend);
; params:
...
.code 
PUBLIC GetErrorSAD_8x8_H264_MMX64_asm 
GetErrorSAD_8x8_H264_MMX64_asm PROC
	;push	rbp
	;mov	rbp, rsp
	;sub	rsp, 16
...
lineLoopComplex:
	...
	movq mm3, qword ptr [rsi + rdx]	;// another 8 pixels in the same row of current MB
	lea	 rsi,  qword ptr [rsi + 2 * rdx]

	movq mm0, qword ptr [rbx]
	movq mm2, qword ptr [rbx + rdx]
	lea	 rbx, [rbx + 2 * rdx]
	...
	movq mm2, qword ptr [rdi + rax]	;// another 8 pixels in the same row of reference MB
	lea	 rdi, qword ptr [rdi + 2 * rax]
...
GetErrorSAD_8x8_H264_MMX64_asm ENDP
End
